...
public final class CelestiumFroglightIrisCompat {
    ...
    private static final String CELESTIUM_BLOCK_ID = "celestium:celestium_block";
    private static final String CELESTIUM_ID = "celestium:celestium";
    ...
    private static void tick(Minecraft client) {
        ...
        try {
            ...
            if (!mappingApplied && (blockMappingUpdated || heldMappingUpdated || packItemMappingUpdated)) {
                Celestium.LOGGER.info("Aliased Celestium block and item to Complimentary/Iris pearlescent froglight material mappings");
            }
            ...
            Celestium.LOGGER.warn("Failed to apply Celestium Iris material aliasing; shader lighting will stay on the default color", exception);
        }
    }
