...
public final class CelestiumRageHud {
    ...
    public static void renderNearHotbar(DrawContext drawContext, PlayerEntity player) {
        ...
        drawContext.drawGuiTexture(BACKGROUND_TEXTURE, barX, barY, barWidth, LeftHotbarStatusBarLayout.BAR_HEIGHT);
        ...
        drawContext.drawGuiTexture(PROGRESS_TEXTURE, barX, barY, progressWidth, LeftHotbarStatusBarLayout.BAR_HEIGHT);
