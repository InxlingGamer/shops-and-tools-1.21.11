...
public final class CelestiumShovelClient {
    ...
    private static void updateOutline(Minecraft client) {
        ...
        if (slamMiningSuppressed || !celestium$canUseAreaMining(client) || client.gameMode == null) {
            return;
        }
        ...
        outlinePositions.addAll(celestium$getAreaMiningTargets(client, hitResult.getBlockPos(), hitResult.getDirection()).outlinePositions());
    }
    ...
    private static CelestiumShovelHelper.AreaMiningTargets celestium$getAreaMiningTargets(Minecraft client, BlockPos centerPos, Direction face) {
