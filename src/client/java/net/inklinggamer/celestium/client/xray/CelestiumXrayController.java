    ...
    private static void handleToggleInput(MinecraftClient client) {
        while (TOGGLE_KEY.wasPressed()) {
            if (!helmetEquipped) {
                ...
                clearOutlines();
                sendActionBar(client, "message.celestium.celestium_xray_requires_helmet");
                continue;
            }
            ...
            sendActionBar(
                    client,
                    xrayEnabledByPlayer
                            ? "message.celestium.celestium_xray_enabled"
                            : "message.celestium.celestium_xray_disabled"
            );
        }
    }
