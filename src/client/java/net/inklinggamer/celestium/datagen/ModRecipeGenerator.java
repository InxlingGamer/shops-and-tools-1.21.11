...
public class ModRecipeGenerator extends RecipeProvider {
    ...
    public void buildRecipes() {
        ...
        ShapedRecipeBuilder.shaped(itemLookup, RecipeCategory.MISC, ModItems.CELESTIUM, 1)
                ...
                .save(this.recipeExporter, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Celestium.MOD_ID, "celestium")));
        ...
        ShapedRecipeBuilder.shaped(itemLookup, RecipeCategory.MISC, ModBlocks.CELESTIUM_BLOCK, 1)
                ...
                .save(this.recipeExporter, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Celestium.MOD_ID, "celestium_block")));
        ...
        ShapelessRecipeBuilder.shapeless(itemLookup, RecipeCategory.MISC, ModItems.CELESTIUM, 9)
                ...
                .save(this.recipeExporter, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Celestium.MOD_ID, "celestium_from_block")));
        ...
        ShapedRecipeBuilder.shaped(itemLookup, RecipeCategory.MISC, ModItems.CELESTIUM_UPGRADE_TEMPLATE, 2)
                ...
                .save(this.recipeExporter, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Celestium.MOD_ID, "celestium_upgrade_template_duplication")));
        ...
        ShapedRecipeBuilder.shaped(itemLookup, RecipeCategory.MISC, ModItems.CELESTIUM_UPGRADE_TEMPLATE, 1)
                ...
                .unlockedBy(getHasName(Items.NETHER_STAR), has(Items.NETHER_STAR))
                .save(this.recipeExporter, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Celestium.MOD_ID, "celestium_upgrade_template")));
        ...
        SmithingTransformRecipeBuilder.smithing(
                ...
                .save(this.recipeExporter, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Celestium.MOD_ID, "celestium_helmet")));
        ...
        SmithingTransformRecipeBuilder.smithing(
                ...
                .unlocks(getHasName(ModItems.CELESTIUM_UPGRADE_TEMPLATE), has(ModItems.CELESTIUM_UPGRADE_TEMPLATE))
                .save(this.recipeExporter, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Celestium.MOD_ID, "celestium_chestplate")));
        ...
        SmithingTransformRecipeBuilder.smithing(
                ...
                .unlocks(getHasName(ModItems.CELESTIUM_UPGRADE_TEMPLATE), has(ModItems.CELESTIUM_UPGRADE_TEMPLATE))
                .save(this.recipeExporter, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Celestium.MOD_ID, "celestium_leggings")));
        ...
        SmithingTransformRecipeBuilder.smithing(
                ...
                .unlocks(getHasName(ModItems.CELESTIUM_UPGRADE_TEMPLATE), has(ModItems.CELESTIUM_UPGRADE_TEMPLATE))
                .save(this.recipeExporter, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Celestium.MOD_ID, "celestium_boots")));
        ...
        SmithingTransformRecipeBuilder.smithing(
                ...
                .unlocks(getHasName(ModItems.CELESTIUM_UPGRADE_TEMPLATE), has(ModItems.CELESTIUM_UPGRADE_TEMPLATE))
                .save(this.recipeExporter, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Celestium.MOD_ID, "celestium_sword")));
        ...
        SmithingTransformRecipeBuilder.smithing(
                ...
                .unlocks(getHasName(ModItems.CELESTIUM_UPGRADE_TEMPLATE), has(ModItems.CELESTIUM_UPGRADE_TEMPLATE))
                .save(this.recipeExporter, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Celestium.MOD_ID, "celestium_pickaxe")));
        ...
        SmithingTransformRecipeBuilder.smithing(
                ...
                .unlocks(getHasName(ModItems.CELESTIUM_UPGRADE_TEMPLATE), has(ModItems.CELESTIUM_UPGRADE_TEMPLATE))
                .save(this.recipeExporter, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Celestium.MOD_ID, "celestium_axe")));
        ...
        SmithingTransformRecipeBuilder.smithing(
                ...
                .unlocks(getHasName(ModItems.CELESTIUM_UPGRADE_TEMPLATE), has(ModItems.CELESTIUM_UPGRADE_TEMPLATE))
                .save(this.recipeExporter, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Celestium.MOD_ID, "celestium_shovel")));
        ...
        SmithingTransformRecipeBuilder.smithing(
                ...
                .unlocks(getHasName(ModItems.CELESTIUM_UPGRADE_TEMPLATE), has(ModItems.CELESTIUM_UPGRADE_TEMPLATE))
                .save(this.recipeExporter, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Celestium.MOD_ID, "celestium_hoe")));
        ...
        SmithingTransformRecipeBuilder.smithing(
                ...
                .unlocks(getHasName(ModItems.CELESTIUM_UPGRADE_TEMPLATE), has(ModItems.CELESTIUM_UPGRADE_TEMPLATE))
                .save(this.recipeExporter, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Celestium.MOD_ID, "celestium_spear")));
        ...
        SmithingTransformRecipeBuilder.smithing(
                ...
                .unlocks(getHasName(ModItems.CELESTIUM_UPGRADE_TEMPLATE), has(ModItems.CELESTIUM_UPGRADE_TEMPLATE))
                .save(this.recipeExporter, ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(Celestium.MOD_ID, "celestium_horse_armor")));
    }
}
