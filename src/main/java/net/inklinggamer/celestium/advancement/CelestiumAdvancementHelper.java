...
public final class CelestiumAdvancementHelper {
    public static final String CELESTIUM_HELMET_ID = Celestium.MOD_ID + ":celestium_helmet";
    public static final String CELESTIUM_CHESTPLATE_ID = Celestium.MOD_ID + ":celestium_chestplate";
    public static final String CELESTIUM_ELYTRA_CHESTPLATE_ID = Celestium.MOD_ID + ":celestium_elytra_chestplate";
    public static final String CELESTIUM_LEGGINGS_ID = Celestium.MOD_ID + ":celestium_leggings";
    public static final String CELESTIUM_BOOTS_ID = Celestium.MOD_ID + ":celestium_boots";
