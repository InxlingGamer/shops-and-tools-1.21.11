...
public class CelestiumChestItem extends ArmorItem {
    private static final Identifier BONUS_HEALTH_MODIFIER_ID = Identifier.of(Celestium.MOD_ID, "celestium_chest_bonus_health");
    ...
    public CelestiumChestItem(Settings settings) {
        super(ModArmorMaterials.CELESTIUM, Type.CHESTPLATE, settings);
    }
