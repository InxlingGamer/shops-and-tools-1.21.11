...
public class CelestiumHoeItem extends HoeItem {
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, TooltipDisplay displayComponent, Consumer<Component> textConsumer, TooltipFlag type) {
        textConsumer.accept(Component.translatable("tooltip.celestium.celestium_hoe_harvest").withStyle(ChatFormatting.GREEN));
        textConsumer.accept(Component.translatable("tooltip.celestium.celestium_hoe_growth_aura").withStyle(ChatFormatting.AQUA));
    }
}
