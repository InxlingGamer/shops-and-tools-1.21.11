...
public final class CelestiumPickaxeHelper {
    ...
    public static boolean isAreaMiningEnabled(ItemStack stack) {
        return celestium$getBoolean(stack, AREA_MINING_ENABLED_KEY);
    }

    public static boolean isSilkModeEnabled(ItemStack stack) {
        return celestium$getBoolean(stack, SILK_MODE_ENABLED_KEY);
    }
    ...
    public static void setAreaMiningEnabled(ItemStack stack, boolean enabled) {
        celestium$setBoolean(stack, AREA_MINING_ENABLED_KEY, enabled);
    }

    public static void setSilkModeEnabled(ItemStack stack, boolean enabled) {
        celestium$setBoolean(stack, SILK_MODE_ENABLED_KEY, enabled);
    }
    ...
    public static void synchronizeEnchantAndModeComponents(ItemStack targetStack, ItemStack sourceStack) {
        ...
        targetStack.set(
                ...
                sourceStack.getOrDefault(DataComponentTypes.ENCHANTMENTS, net.minecraft.component.type.ItemEnchantmentsComponent.DEFAULT)
        );
        targetStack.set(
                DataComponentTypes.CUSTOM_DATA,
                sourceStack.getOrDefault(DataComponentTypes.CUSTOM_DATA, net.minecraft.component.type.NbtComponent.DEFAULT)
        );
    }
    ...
    public static float getMiningDelta(PlayerEntity player, World world, BlockPos pos, GameMode gameMode) {
        ...
        if (tool.isEmpty() || !tool.getItem().canMine(state, world, pos, player)) {
            return 0.0F;
        }
    ...
    private static void applyEnchantMode(ItemStack stack, DynamicRegistryManager registryManager, boolean silkModeEnabled) {
        ...
        RegistryEntry<Enchantment> efficiency = celestium$getEnchantment(enchantmentRegistry, Enchantments.EFFICIENCY);
        RegistryEntry<Enchantment> unbreaking = celestium$getEnchantment(enchantmentRegistry, Enchantments.UNBREAKING);
        RegistryEntry<Enchantment> fortune = celestium$getEnchantment(enchantmentRegistry, Enchantments.FORTUNE);
        RegistryEntry<Enchantment> silkTouch = celestium$getEnchantment(enchantmentRegistry, Enchantments.SILK_TOUCH);
    ...
    private static RegistryEntry<Enchantment> celestium$getEnchantment(Registry<Enchantment> registry, net.minecraft.registry.RegistryKey<Enchantment> key) {
    ...
    private static boolean canVeinMineOre(PlayerEntity player, World world, BlockPos pos, BlockState state, GameMode gameMode) {
        ...
        ItemStack tool = player.getMainHandStack();
        return !tool.isEmpty() && tool.getItem().canMine(state, world, pos, player);
    }
    ...
    private static boolean celestium$getBoolean(ItemStack stack, String key) {
    ...
    private static void celestium$setBoolean(ItemStack stack, String key, boolean value) {
