...
import net.inklinggamer.celestium.item.CelestiumHorseArmorItem;
...
public final class CelestiumHorseArmorManager {
    ...
    static final Identifier BONUS_HEALTH_MODIFIER_ID = Identifier.of(Celestium.MOD_ID, "celestium_horse_armor_bonus_health");
    static final Identifier STEP_HEIGHT_MODIFIER_ID = Identifier.of(Celestium.MOD_ID, "celestium_horse_armor_step_height");
    ...
    private static void applyBonusHealth(AbstractHorseEntity horse) {
        EntityAttributeInstance maxHealthAttribute = horse.getAttributeInstance(EntityAttributes.GENERIC_MAX_HEALTH);
    ...
    private static void applyStepHeight(AbstractHorseEntity horse) {
        EntityAttributeInstance stepHeightAttribute = horse.getAttributeInstance(EntityAttributes.GENERIC_STEP_HEIGHT);
