...
public final class CelestiumSpearHelper {
    ...
    public static void initializeSmithingResult(ItemStack stack, RegistryAccess registryManager) {
        ...
        Holder<Enchantment> lunge = shopsandtools$getEnchantment(enchantmentRegistry, Enchantments.LUNGE);
        Holder<Enchantment> mending = shopsandtools$getEnchantment(enchantmentRegistry, Enchantments.MENDING);
