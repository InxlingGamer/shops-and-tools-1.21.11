...
public record SyncCelestiumWallClimbInputPayload(boolean sneakHeld, boolean forwardHeld, boolean leftHeld, boolean rightHeld) implements CustomPayload {
    ...
    public static final PacketCodec<PacketByteBuf, SyncCelestiumWallClimbInputPayload> CODEC = PacketCodec.of(
            ...
            buf -> new SyncCelestiumWallClimbInputPayload(buf.readBoolean(), buf.readBoolean(), buf.readBoolean(), buf.readBoolean())
    );
    ...
    public static void send(boolean sneakHeld, boolean forwardHeld, boolean leftHeld, boolean rightHeld) {
        ClientPlayNetworking.send(new SyncCelestiumWallClimbInputPayload(sneakHeld, forwardHeld, leftHeld, rightHeld));
    }
