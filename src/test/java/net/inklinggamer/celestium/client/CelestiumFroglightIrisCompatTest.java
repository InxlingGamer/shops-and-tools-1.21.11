...
public final class CelestiumFroglightIrisCompatTest {
    ...
    private static void assertHeldItemAliasesUseReplacementMap() {
        ...
        assertEquals("Celestium block items should reuse the Pearlescent Froglight held-light material ID", 44009, patchedItemIds.getInt("celestium:celestium_block"));
        assertEquals("Loose Celestium should reuse the Pearlescent Froglight held-light material ID", 44009, patchedItemIds.getInt("celestium:celestium"));
        assertEquals("The original unmodifiable map should stay unchanged for Celestium block items", -1, originalItemIds.getInt("celestium:celestium_block"));
        assertEquals("The original unmodifiable map should stay unchanged for loose Celestium", -1, originalItemIds.getInt("celestium:celestium"));
    }
    ...
    private static void assertGenericAliasHelperUsesReplacementMap() {
        ...
        Object2IntMap<String> patchedIds = CelestiumFroglightIrisCompat.createPatchedAliasIds(
                originalIds,
                "celestium:celestium_block_state",
        ...
        assertEquals("Celestium block-state aliases should reuse the source material ID", 10688, patchedIds.getInt("celestium:celestium_block_state"));
        assertEquals("The original alias source map should stay unchanged", -1, originalIds.getInt("celestium:celestium_block_state"));
    }
